...
namespace rdt {
	...
	bool  UTILS_API operator==(const Vec2d& vector1, const Vec2d& vector2);
	Vec2d UTILS_API operator* (float multiplier, const Vec2d& vector);
	Vec2d UTILS_API operator* (const Vec2d& vector, float multiplier);
	Vec2d UTILS_API operator* (double multiplier, const Vec2d& vector);
	Vec2d UTILS_API operator* (const Vec2d& vector1, const Vec2d& vector2);
	Vec2d UTILS_API operator* (const Vec2d& vector, double multiplier);
	Vec2d UTILS_API operator+ (const Vec2d& vector1, const Vec2d& vector2);
	Vec2d UTILS_API operator- (const Vec2d& vector1, const Vec2d& vector2);
	Vec2d UTILS_API operator/ (const Vec2d& vector, const double divider);
	Vec2d UTILS_API operator/ (const Vec2d& vector1, const Vec2d& vector2);

	

	struct UTILS_API Vec3f {
		float x, y, z;
